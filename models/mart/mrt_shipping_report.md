...
Derives from `int_local_bike_database__orders` only, with no join. Excludes cancelled/blocked orders (`order_status = 3`): shipping management is irrelevant for them.
