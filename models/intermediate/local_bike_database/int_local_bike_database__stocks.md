...
Joins `stg_local_bike_database__stocks` (current stock on hand) with sales aggregated from `int_local_bike_database__order_items`, and with `int_local_bike_database__products` for readable labels.
